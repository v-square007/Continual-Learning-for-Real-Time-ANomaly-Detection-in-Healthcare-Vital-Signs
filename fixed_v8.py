...
Version 8 — Baseline Comparison + Continual Learning + Expanded Evaluation
=============================================================================
...
def evaluate_model(results: pd.DataFrame, ifm: StreamingIF,
    ...
    for fv in warmup_X[:20]:
        ...
        pert = ifm.score_raw(fv + rng.normal(0, noise_scale, fv.shape))
    ...
    if score_increases:
        ...
        print("  [Check 3] Perturbation: no valid warmup windows to perturb")
